<template>
  <div class="json-editor">
    <el-tabs v-model="activeTabName" type="border-card" addable closable @tab-add="createTab" @tab-remove="closeTab"
      ...
      <el-tab-pane v-for="(tab, id) in jsonEditorTabs" :key="id" :name="String(id)" :closable="String(id) !== 'default'"
        :label="String(id) === 'default' ? 'JSON 编辑器' : `JSON 编辑器 ${Object.keys(jsonEditorTabs).indexOf(String(id))}`">
      </el-tab-pane>
    </el-tabs>
